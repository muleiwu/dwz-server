...
-- +goose Down
DROP INDEX `idx_click_statistics_workspace_route_click_date` ON `click_statistics`;
DROP INDEX `idx_click_statistics_workspace_campaign_click_date` ON `click_statistics`;
DROP INDEX `idx_click_statistics_workspace_short_link_click_date` ON `click_statistics`;
DROP INDEX `idx_click_statistics_workspace_country_province_click_date` ON `click_statistics`;
DROP INDEX `idx_click_statistics_workspace_country_click_date` ON `click_statistics`;
DROP INDEX `idx_click_statistics_workspace_click_date` ON `click_statistics`;
